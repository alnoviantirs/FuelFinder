...
<head>
    ...
    <title>Detail SPBU Pertamina</title>
...
<body style="background-color: #ff6b81;">
    <!-- Start SPBU Detail Section -->
    <section id="spbuDetail" class="about-info-area section-gap">
      <div class="container" style="padding-top: 120px;">
          <div class="row">
              <div class="col-md-7" data-aos="fade-up" data-aos-delay="200">
                  <div class="card panel panel-info panel-dashboard">
                      <div class="card-header centered">
                          <h2 class="card-title panel-title text-center"><strong>SPBU Detail</strong></h2>
                      </div>
                      <div class="card-body">
                          <table class="table">
                              <tr>
                              ...
                              <tr>
                                  ...
                                  <td>
                                      <h5>{{ $spbu->jam_operasional }}</h5>
                                  </td>
                              </tr>
                              <tr>
                                  <td>Jenis Bahan Bakar</td>
                                  <td>
                                      <h5>{{ $spbu->jenis_bahan_bakar }}</h5>
                                  </td>
                              </tr>
                              <tr>
                                  <td>Telepon</td>
