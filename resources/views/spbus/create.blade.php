...
@section('title', 'Create Data SPBU')

@section('content_header')
    <h1 class="m-0 text-dark">Tambah Data SPBU</h1>
@stop

@section('content')
    <form action="{{ route('spbus.store') }}" method="post" id="spbuForm">
        @csrf
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body" style="overflow:auto">
                        <table style="width:100%">
                            <tr>
                                ...
                                <td><input type="text" size="70" id="InputNama" placeholder="Nama SPBU" name="namaspbu"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><input type="text" size="70" id="InputJenisBahanBakar" placeholder="Jenis Bahan Bakar" name="jenis_bahan_bakar"></td>
                            </tr>
                            <tr>
                                <td><label for="InputTelepon">Telepon</label></td>
                                <td><input type="text" size="70" id="InputTelepon" placeholder="Telepon" name="telepon"></td>
                            </tr>
                            <tr>
                                <td><label for="InputFasilitas">Fasilitas</label></td>
                                <td><input type="text" size="70" id="InputFasilitas" placeholder="Fasilitas" name="fasilitas"></td>
                            </tr>
                            <tr>
...
<script>
    ...
    document.getElementById('simpanButton').addEventListener('click', function () {
        ...
        Swal.fire({
            title: 'Simpan Data Spbu?',
            text: 'Apakah Anda yakin ingin menyimpan data spbu?',
            icon: 'question',
            ...
            // Jika pengguna menekan tombol Ya, kirimkan formulir
